...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ls.numberOfLibraries ; i++) {
          ListIterator<Book> listIterator = ls.libraries[i].books.listIterator();
            while (listIterator.hasNext()){  
              tempBook = listIterator.next();
              if(book.equals(tempBook) && tempBook.rs == null){
                ...
                while (listIterator.hasNext()){  
                    ...
                    if(book.equals(tempBook)){
                        System.out.println(ls.libraries[i].libraryName()+":");
                          ...
                          if(tempBook.isRented(ls.libraries[i]) == true){
                            System.out.println("The book is borrowed.");

                            try{
                              if(tempBook.isBookOverdue() == true){
                                System.out.println("Is the book overdue: yes");
                                System.out.println("The book can be borrowed: "+tempBook.availableDate(ls.libraries[i]));
                              } else {
        ...
        for (int i = 0; i < ls.numberOfLibraries ; i++) {
          ListIterator<Book> listIterator = ls.libraries[i].books.listIterator();
            while (listIterator.hasNext()){  
              tempBook = listIterator.next();
              try{
                if(book.equals(tempBook) && tempBook.rs != null && Helper.timeDifference(closest,tempBook.getDueDate()) < 0){
                  closest = tempBook.getDueDate();
         ...
         * */
        System.out.println("\n\n *" + " TASK 8 " + "*");
        System.out.println("LinkedList<T> is implemented in the project LinkedList Version.\n");
